...
namespace Mojio.Client
{
    public interface IMojioClient
    {
        ...
        Results<M> GetBy<M, T>(object id, out System.Net.HttpStatusCode code, out string message, int page = 1, string action = null, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : new();
        Results<M> GetBy<M, T>(object id, out System.Net.HttpStatusCode code, int page = 1, string action = null, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : new();
        Results<M> GetBy<M, T>(object id, int page = 1, string action = null, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : new();
        Results<M> GetBy<M, T>(T entity, out System.Net.HttpStatusCode code, out string message, int page = 1, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : BaseEntity, new();
        Results<M> GetBy<M, T>(T entity, out System.Net.HttpStatusCode code, int page = 1, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : BaseEntity, new();
        Results<M> GetBy<M, T>(T entity, int page = 1, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : BaseEntity, new();
        System.Threading.Tasks.Task<MojioResponse<Results<M>>> GetByAsync<M, T>(object id, int page = 1, string action = null, System.Linq.Expressions.Expression<Func<M, object>> sortBy = null, bool desc = false, string criteria = null) where T : new();
