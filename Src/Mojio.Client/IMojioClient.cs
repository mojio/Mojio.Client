...
namespace Mojio.Client
{
    public interface IMojioClient
    {
        ...
        Results<T> Get<T>(out HttpStatusCode code, out string message, int page = 1, string criteria = null) where T : new();

        Results<T> Get<T>(out HttpStatusCode code, int page = 1, string criteria = null) where T : new();

        Results<T> Get<T>(int page = 1, string criteria = null) where T : new();
        ...
        Task<Client.MojioResponse<Results<T>>> GetAsync<T>(int page = 1, string criteria = null) where T : new();
