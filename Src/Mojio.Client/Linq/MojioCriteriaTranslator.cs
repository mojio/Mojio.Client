...
// 4.5 framework:                if (type.GetTypeInfo().IsSubclassOf(typeof(Enum)))
...
// 4.5 framework:                    if (constantType.GetTypeInfo().IsGenericType)
                {
...
// 4.5 framework:                        return constantType.GetTypeInfo().GenericTypeArguments[0];
                    }
                }
            }
